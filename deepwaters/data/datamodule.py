...
from deepwaters.data.dataset import DeepwatersDataset
from deepwaters.preprocessing import RobustScaler, StandardScaler
from deepwaters.regions import select_basins, select_continents, select_countries
...
class DeepwatersDataModule(L.LightningDataModule):
    """
    ...
    def __init__(
        ...
        **dl_kwargs,
        ...
        """
        Initializes the DeepwatersDataModule.
        ...
        time_notnull = inputs.dw.time_notnull()
        ...
        with dask.config.set(**{"array.slicing.split_large_chunks": False}):
            ...
            match pred.ndim:
                ...
                case 2:
                    ...
                    xr_pred = xr.merge([da_pred, da_uncert]).dw.unstack_spacetime()
                case d:
    ...
    def _create_lookup(
        ...
        lookup = (
            merged.target.dw.stack_spacetime().get_index("sample").to_frame().to_numpy()
        )
    ...
    def _prepare_tensors(self, partition: Partition) -> dict[str, Tensor]:
        ...
        if target is not None:
            ...
            target = target.dw.stack_spacetime()
